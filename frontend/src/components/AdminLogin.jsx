              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoCapitalize="off"
                    spellCheck="false"
                    className="w-full pl-12 pr-14 py-4 bg-paper-warm/50 border border-ink-100 rounded-2xl focus:border-gold-calligraphy focus:bg-white focus:ring-4 focus:ring-gold-calligraphy/5 transition-all outline-none font-body text-ink-900"
                    placeholder="••••••••"
                  />
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-4 flex items-center text-ink-300 hover:text-gold-calligraphy transition-colors focus:outline-none"
                    tabIndex={-1}
                ...
                {/* Mobile hint */}
                <p className="text-[10px] text-ink-400 mt-1.5 px-1 opacity-60">
                  Tap 👁 to verify your password before submitting
                </p>
              </div>
